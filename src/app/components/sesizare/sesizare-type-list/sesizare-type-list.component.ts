...
export class SesizareTypeListComponent implements OnInit {
		...
		this.dtOptions = {
			...
			ajax: (dataTablesParameters: any, callback) => {
				...
				.post<DataTablesResponse>(
					'http://ps6-web.back.lc/api/sesizare-types',
			...
			columns: [{ title: 'ID', data: 'id_sesizare_type' }, { title: 'Nume', data: 'name' }, { title: 'Actiuni', data: 'actions', orderable: false}],
		};
	}
